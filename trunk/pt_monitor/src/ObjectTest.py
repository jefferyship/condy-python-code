...
class Test(unittest.TestCase):
    ...
    def testServiceInputParam(self):
        #url="http://192.168.0.94:9080/iservuc/ServiceGate/SimpleXMLGate"
        ...
        inputStr='059110139'+LinkConst.SPLIT_COLUMN+'成功'
        outputParam=paramUtil.invoke("Agent_GetHttpInfo", inputStr, url)
